  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Overview of your uploaded budget data (showing first 5 Campaigns)
        </CardDescription>
      </CardHeader>
      <CardContent>
        {/* Summary Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-orange-50 p-3 rounded-lg">
            ...
            <div className="text-sm text-orange-700">Growing Campaigns</div>
          </div>
        </div>
                  ...
                  <TableRow key={index}>
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{product['Targeting Value']}</div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="text-right">₹{(product['Total Spend - Period 1'])}</TableCell>
                    <TableCell className="text-right">₹{(product['Total Spend - Period 2'])}</TableCell>
                    <TableCell className="text-right">{product['ROI - Period 1'].toFixed(0)}x</TableCell>
        ...
        {data.length > 5 && (
          <p className="text-sm text-gray-500 mt-4 text-center">
            ... and {data.length - 5} more campaigns
          </p>
        )}
      </CardContent>
    </Card>
